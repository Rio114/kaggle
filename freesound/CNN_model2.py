...
def CNN_Model(num_freq = 128, len_div = 256):
    ...
    conv1_1 = Conv2D(8, (3, 3),activation='relu',padding='same',name='conv1_1')(drop1)
    pool1_1 = MaxPooling2D((3, 3),strides=(2, 2),padding='same',name='pool1_1')(conv1_1)
    norm1_1 = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001,name='norm1_1')(pool1_1)
    drop1_1 = Dropout(rate=0.05)(norm1_1)

    conv1_2 = Conv2D(8, (3, 3),activation='relu',padding='same',name='conv1_2')(drop1_1)
    pool1_2 = MaxPooling2D((3, 3),strides=(2, 2),padding='same',name='pool1_2')(conv1_2)
    ...
    ## Block 2
    conv2 = Conv2D(8, (7, 7),activation='relu',padding='same',name='conv2')(inputs)
    pool2 = MaxPooling2D((7, 7), strides=(2, 2), padding='same',name='pool2')(conv2)
    norm2 = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001,name='norm2')(pool2)
    drop2 = Dropout(rate=0.05)(norm2)

    conv2_1 = Conv2D(8, (5, 5),activation='relu',padding='same',name='conv2_1')(drop2)
    pool2_1 = MaxPooling2D((5, 5), strides=(2, 2), padding='same',name='pool2_1')(conv2_1)
    norm2_1 = BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001,name='norm2_1')(pool2_1)
    drop2_1 = Dropout(rate=0.05)(norm2_1)

    conv2_2 = Conv2D(8, (3, 3),activation='relu',padding='same',name='conv2_2')(drop2_1)
    pool2_2 = MaxPooling2D((3, 3), strides=(2, 2), padding='same',name='pool2_2')(conv2_2)
